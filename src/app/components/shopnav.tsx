    ...
    <nav className="w-full border-b-2 border-gray-300 p-4">
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        ...
        <div className="hidden md:flex gap-4">
          ...
          <Link href={"/shop"} className="text-sm font-normal hover:text-blue-600 hover:underline flex">
            Shop<FaChevronDown className="mt-1 font-thin"/>
          </Link>
        ...
        <div className="hidden md:flex items-center gap-4 mr-9">
          ...
          <Button variant={"outline"} size={"icon"} className="rounded-full text-blue-600 hover:bg-blue-800">
            <Search />
          </Button>
